...
import laravel from '../../asset/image/icon/laravel.svg';
import next from '../../asset/image/icon/nextjs.svg';
import webpack from '../../asset/image/icon/webpack.svg';
    ...
    let mock_detail = [
        {
            ...
            is_active: 0,
            description: 'It sets up your development environment so that you can use the latest JavaScript features, provides a nice developer experience, and optimizes your app for production. You’ll need to have Node >= 8.10 and npm >= 5.6 on your.',
                                    ...
                                    <div
                                        ...
                                        <div className={`${css.projectLogoParent}`}>
                                            <div className={css.imageParent}>
                                                <img src={eachItem.logo} alt="Developers" title="Developers"/>
                                            </div>
                                            <h3 className={css.projectTitle}>{eachItem.title}</h3>
                                        </div>
                                        <h4 className={`${general.status} ${!eachItem.is_active ? general.doing : general.done}`}>{!eachItem.is_active ? 'in progress' : 'done'}</h4>
                                    </div>
                                    <p className={css.description}>{eachItem.description}</p>
                                </div>
                            </li>
                            <li className={css.item}>
                                <div className={css.url}>
                                    <span>URL :</span>
                                    <a href={eachItem.url_address} target="_blank">{eachItem.url_text}</a>
                                </div>
                            </li>
                            <li className={css.item}>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div className={css.type}>
                                                <span>
                                                    <img src={android} title="android application" alt=""/>
                                                </span>
                                                <span>
                                                    <img src={website} title="web application" alt=""/>
                                                </span>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div className={css.type}>
                                                 <span>
                                        <img src={react} title="android application" alt=""/>
                                    </span>
                                                <span>
                                        <img src={node} title="android application" alt=""/>
                                    </span>
                                                <span>
                                        <img src={next} title="android application" alt=""/>
                                    </span>
                                                <span>
                                        <img src={antd} title="android application" alt=""/>
                                    </span>
                                            </div>
                                        </li>
                                        <li className={css.developers}>
                                            ...
                                            <div className={css.type}>
                                                <span>
                                                    <img src={Image_two} title="android application" alt=""/>
                                                </span>
                                                <span>
                                        <img src={Image_three} title="android application" alt=""/>
                                    </span>
                                                <span>
                                        <img src={Image_four} title="android application" alt=""/>
                                    </span>
                                                <span>
                                        <img src={Image_one} title="android application" alt=""/>
                                    </span>
                                            </div>
                                        </li>
                                    </ul>
